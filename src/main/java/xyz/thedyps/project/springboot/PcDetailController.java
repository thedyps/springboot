...
import xyz.thedyps.project.springboot.goods.exception.PcDetailNotFoundException;
import xyz.thedyps.project.springboot.goods.exception.PcImgNotFoundException;
import xyz.thedyps.project.springboot.goods.exception.PcSummaryNotFoundException;
...
@RestController
@CrossOrigin
@RequestMapping(path = "/goods/detail")
